...
module.exports.nSmarty = nSmarty;
...
** ******************************************* **/
    ...
    */
    ...
    {
        if (nocache || !(name in nSmarty.cache_files))
        {
	        ...
	        nSmarty.cache_files[name] = tree;
        }
        else
        {
            tree = nSmarty.cache_files[name];
        }
        return tree;
    }
    ...
    */
    ...
    {
        if(nSmarty._phpjs){
            return nSmarty._phpjs;
        }
        else if (eval('typeof '+fnm) == 'function')
        {
